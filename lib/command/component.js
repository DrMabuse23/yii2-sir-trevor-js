    ...
    switch (component.toLocaleLowerCase()) {
        case 'bikini':
            generator.createBikini(options, function (err, destination) {
                ...
                console.log(chalk.green('Bikini Component successfully created. %s'), chalk.grey(destination));
            });
            break;
        case 'connectionconfiguration':
            generator.createConnectionConfiguration(options, function (err, destination) {
                ...
                console.log(chalk.green('Connection Configuration successfully created. %s'), chalk.grey(destination));
            });
            break;
        case 'model':
            generator.createModel(options, function (err, destination) {
                ...
                console.log(chalk.green('Model successfully created. %s'), chalk.grey(destination));
            });
            break;
        case 'rest':
        case 'saprfc':
        ...
        case 'sql':
            generator.createConnection(options, function (err, destination) {
                ...
                console.log(chalk.green('Connection successfully created. %s'), chalk.grey(destination));
            });
            break;
    }
}
